...
4. The current focused target passes 142 tests in 20 suites in
   `docs/local/production-readiness/20260517T_parser_cache_nonexcluded_current/MLXLMCommonFocusedTests_all.log`,
   including parser/no-leak, cache topology, server settings, MTP runtime,
